            ...
            <div id="navbarCollapse" class="collapse navbar-collapse">
              <BootstrapNavbarNav class="ms-auto">
                <BootstrapNavItem
                  ...
                  to="/"
                  :link-attrs="{ title: 'Strona główna' }"
                  >Strona główna</BootstrapNavItem
                >
                <BootstrapNavItem
                  link-classes="text-white"
                  to="/blog/"
                  :link-attrs="{ title: 'Blog' }"
                  >Blog</BootstrapNavItem
                >
                <BootstrapNavItem
                  v-if="!modeSwitcher"
                  href="#"
      ...
      >
        <div class="container-fluid">
          <span
            ...
            "
          >
            Copyrights&copy; {{ currentYear }} MojeZapiski.pl
            by <ExternalLink page="https://pawel-wilczek.mojezapiski.pl/" anchor="odwiedź moją wizytówkę Internetową" class="text-white">Paweł Wilczek</ExternalLink>
          </span>
