...
const skip = ref(0);
const limit = ref(10);
const title = ref('O życiu w IT i nie tylko');
const description = ref('Zapraszam do zapoznania się z moją stroną "MojeZapiski.pl"! Tutaj odkryjesz fascynujący świat programowania, opisany z perspektywy pasjonata, który kocha kodowanie. Dołącz do podróży ze mną, aby razem będziemy odkrywać nowe horyzonty, tworzyć, eksperymentować i dzielić się wiedzą.');
